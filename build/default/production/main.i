...
void LED_RUN(_Bool LED_1,_Bool LED_2,_Bool LED_3)
{
    if(LED_1)
    {
        LED_UP_ON();
...
void main(void)
{
    ...
    while (1)
    {
        ...
        if(MTOUCH_Service_Mainloop())
        {
            ...
            if(turn_off == 1 && turn_on == 0 && turn_up == 0 && turn_down == 0)
            {
                counter_1s++;
                if(counter_1s >= 30)
                {
            ...
            if(turn_on == 1 &&turn_off == 0 && turn_up == 0 && turn_down == 0)
            {
                counter_1s++;
                if(counter_1s >= 30)
                {
            ...
            if(turn_off == 0 && turn_on == 0 && turn_up == 1 && turn_down == 0)
            {
                counter_1s++;
                if(counter_1s >= 30)
                {
            ...
            if(turn_off == 0 && turn_on == 0 && turn_up == 0 && turn_down == 1)
            {
                counter_1s++;
                if(counter_1s >= 30)
                {
