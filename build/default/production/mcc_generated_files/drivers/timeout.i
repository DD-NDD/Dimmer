...
# 2 "<built-in>" 2
# 1 "mcc_generated_files/drivers/timeout.c" 2
# 24 "mcc_generated_files/drivers/timeout.c"
...
# 24 "mcc_generated_files/drivers/timeout.c" 2
...
# 26 "mcc_generated_files/drivers/timeout.c" 2

# 1 "mcc_generated_files/drivers/timeout.h" 1
# 26 "mcc_generated_files/drivers/timeout.h"
...
# 26 "mcc_generated_files/drivers/timeout.h" 2

# 1 "C:\\Program Files (x86)\\Microchip\\xc8\\v2.05\\pic\\include\\c99\\stdbool.h" 1 3
# 27 "mcc_generated_files/drivers/timeout.h" 2
...
__attribute__((inline)) void timeout_callNextCallback(void);
...
# 27 "mcc_generated_files/drivers/timeout.c" 2

# 1 "mcc_generated_files/drivers/../tmr0.h" 1
# 104 "mcc_generated_files/drivers/../tmr0.h"
void TMR0_Initialize(void);
# 135 "mcc_generated_files/drivers/../tmr0.h"
uint8_t TMR0_ReadTimer(void);
# 174 "mcc_generated_files/drivers/../tmr0.h"
void TMR0_WriteTimer(uint8_t timerVal);
# 210 "mcc_generated_files/drivers/../tmr0.h"
void TMR0_Reload(void);
# 225 "mcc_generated_files/drivers/../tmr0.h"
void TMR0_ISR(void);
# 243 "mcc_generated_files/drivers/../tmr0.h"
void TMR0_CallBack(void);
# 261 "mcc_generated_files/drivers/../tmr0.h"
 void TMR0_SetInterruptHandler(void (* InterruptHandler)(void));
# 279 "mcc_generated_files/drivers/../tmr0.h"
extern void (*TMR0_InterruptHandler)(void);
# 297 "mcc_generated_files/drivers/../tmr0.h"
void TMR0_DefaultInterruptHandler(void);
# 28 "mcc_generated_files/drivers/timeout.c" 2
...
_Bool sortedInsert(timerStruct_t *timer)
{
    ...
    {
        timerAbsoluteTime += (255) - rebaseList() + 1;
...
void startTimerAtHead(void)
{
    ...
    if (period > (255))
    {
        dummy.absoluteTime = absoluteTimeofLastTimeout + (255);
        dummy.next = listHead;
        listHead = &dummy;
        period = (255);
    }
...
# 289 "mcc_generated_files/drivers/timeout.c"
__attribute__((inline)) void timeout_callNextCallback(void)
{
    if (executeQueueHead == ((void*)0))
        return;

    _Bool tempIE = (INTCONbits.TMR0IE == 1?1:0);
    INTCONbits.TMR0IE = 0;
